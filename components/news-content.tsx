...
import { BarChart, TrendingUp, TrendingDown, AlertTriangle, FileText, Globe, DollarSign, Building, Share2, BookOpen, Clock } from 'lucide-react'
...
const newsData = [
    {
        ...
        summary: 'The Federal Reserve has indicated a potential 25 basis point rate cut in September, citing improving inflation data and concerns about labor market cooling.',
    ...
    },
    {
        ...
        summary: 'The Securities and Exchange Commission has approved new rules requiring public companies to disclose climate-related risks and greenhouse gas emissions.',
    ...
    },
    {
        ...
        summary: 'Technology stocks led a broad market rally on Wednesday as investors remain optimistic about artificial intelligence growth prospects and potential rate cuts.',
        source: 'Bloomberg',
        date: '8 hours ago',
        category: 'market',
    ...
    },
    {
        ...
        summary: "The OECD's global minimum corporate tax of 15% is moving to implementation phase, with 136 countries now committed to the framework.",
        source: 'Reuters',
        date: 'Yesterday',
        category: 'regulatory',
    ...
    },
    {
        ...
        summary: 'The U.S. housing market is showing signs of cooling with existing home sales declining for the third consecutive month as mortgage rates remain above 6%.',
        source: 'CNBC',
        date: 'Yesterday',
        category: 'economic',
    ...
    },
    {
        ...
        summary: 'Oil prices have surged to a three-month high amid escalating tensions in the Middle East and concerns about global supply constraints.',
        source: 'Financial Times',
        date: 'Yesterday',
        category: 'market',
    ...
    },
    {
        ...
        summary: 'U.S. GDP grew at an annualized rate of 3.1% in the second quarter, exceeding economist expectations of 2.4% and showing resilience in the face of high interest rates.',
        source: 'Bloomberg',
        date: '2 days ago',
        category: 'economic',
    ...
    },
    {
        ...
        summary: 'Two of the largest healthcare providers announced a $45 billion merger that would create the largest integrated healthcare system in the country.',
        source: 'Wall Street Journal',
        date: '2 days ago',
        category: 'market',
    ...
    },
    {
        ...
        summary: 'Bipartisan legislation has been introduced in Congress that would expand retirement savings options and increase catch-up contribution limits for older workers.',
        source: 'CNBC',
        date: '3 days ago',
        category: 'regulatory',
    ...
    },
    {
        ...
        summary: 'The latest Consumer Price Index (CPI) data shows continued moderation in core inflation, supporting the case for potential interest rate cuts later this year.',
        source: 'Reuters',
        date: '3 days ago',
        category: 'economic',
...
export function NewsContent({ searchQuery, activeFilters, activeCategory, loading }: NewsContentProps) {
    ...
    const filteredNews = newsData.filter((news) => {
        ...
        if (searchQuery && !news.title.toLowerCase().includes(searchQuery.toLowerCase()) && !news.summary.toLowerCase().includes(searchQuery.toLowerCase()) && !news.tags.some((tag) => tag.toLowerCase().includes(searchQuery.toLowerCase()))) {
            return false
        }
    ...
    if (filteredNews.length === 0) {
        return (
            <div className="py-12 text-center">
                ...
                <p className="text-muted-foreground">No news articles match your current filters. Try adjusting your search criteria.</p>
            </div>
        )
    }
    ...
    return (
        <div className="space-y-6">
            {filteredNews.slice(0, visibleNews).map((news) => (
                <div
                    key={news.id}
                    className="flex flex-col gap-4 rounded-lg border p-4 transition-colors hover:bg-muted/50 md:flex-row"
                >
                    <div className="mb-2 flex items-center justify-between md:hidden">
                        <div className="flex items-center gap-2">
                            <div className="rounded-full bg-primary/10 p-1.5">{news.icon}</div>
                            <Badge variant={news.impact === 'high' ? 'destructive' : 'outline'}>{news.impact === 'high' ? 'High Impact' : 'Medium Impact'}</Badge>
                        </div>
          ...
          /> */}
                    ...
                    <div className="flex-1">
                        ...
                        <h3 className="mb-1 text-base font-medium">{news.title}</h3>
                        <p className="mb-2 text-sm text-muted-foreground">{news.summary}</p>
                        ...
                        <div className="mt-2 flex flex-wrap items-center gap-2">
                            ...
                            <Badge
                                ...
                                className="text-xs"
                            >
                                {news.category === 'market' ? 'Market News' : news.category === 'regulatory' ? 'Regulatory Update' : 'Economic Indicator'}
                            </Badge>
